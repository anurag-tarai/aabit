package com.aabit.backend.config;

import com.aabit.backend.auth.context.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .csrf(AbstractHttpConfigurer::disable) // Disable CSRF for stateless JWT interaction layers
