...
import { LogOut, ShieldAlert, X, Power, Layers, Activity, Flame } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#e5e5e5] font-sans p-3 sm:p-6 md:p-8 flex flex-col items-center selection:bg-neutral-800 selection:text-white">
      <div className="w-full max-w-2xl flex flex-col gap-5">
        ...
        <div className="relative overflow-hidden border-b border-neutral-800 pb-3 tracking-wider min-h-[40px] sm:min-h-[28px]">
          ...
          {/* State B: Inline Session Termination Guard Drawer */}
        ...
        {/* Plug-and-Play Cyberpunk Tabbed Navigation Bar */}
        <div className="grid grid-cols-3 gap-2 text-center font-mono text-[11px]">
          <button
            onClick={() => navigate('/')}
            className={`flex items-center justify-center gap-1.5 py-2 border rounded transition-all cursor-pointer ${
              isActive('/') 
                ? 'bg-neutral-900 border-neutral-700 text-white shadow-sm font-bold' 
                : 'border-neutral-900 text-neutral-500 hover:text-neutral-300 hover:border-neutral-800 bg-black'
            }`}
          >
            <Activity size={12} />
        ...
        {/* Master Active Module Screen Mount Point Slot */}
