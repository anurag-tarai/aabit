        ...
        <div className="flex flex-col items-end gap-2 md:flex-row md:items-center md:gap-4">
          ...
          <div className={`${showMobileMenu ? 'flex' : 'hidden'} md:flex flex-row flex-wrap justify-end items-center gap-3 md:gap-4 mt-3 md:mt-0 animate-in fade-in slide-in-from-top-2 duration-200`}>
            <div className="relative">
              ...
              {showSprintList && (
                <div className="absolute left-0 md:left-auto md:right-0 top-full mt-2 w-64 bg-[#0a0a0a] border border-neutral-800 rounded shadow-2xl z-20 flex flex-col overflow-hidden font-mono animate-in fade-in slide-in-from-top-1 duration-150">
                  {sprints.map(s => (
